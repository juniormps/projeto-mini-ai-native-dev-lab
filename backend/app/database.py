    ...
    with get_connection() as connection:
        ...
        if count == 0:
            connection.executemany(
                ...
                [
                    (
                        "Reparar vazamento na garagem",
                        "Manutenção",
                        "Verificar e corrigir vazamento próximo às vagas dos carros",
                        "Em andamento",
                        "Marina",
                        "2026-04-11",
                    ),
                    (
                        "Multirão de limpeza da quadra de esportes",
                        "Limpeza",
                        "Realizar limpeza e revitalização da quadra de esportes",
                        "Pendente",
                        "Carlos",
                        "2026-04-25",
                    ),
                    (
                        ...
                        "Comunidade",
                        "Assembléia de moradores para discutir horário de encerramento de festas no salão e limite de barulho",
                        "concluída",
                        "Luciana",
                        "2026-02-18",
                    ),
